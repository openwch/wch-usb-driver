/********************************** (C) COPYRIGHT  *******************************
 * File Name          : ch32v205_pioc.h
 * Author             : WCH
 * Version            : V1.0.0
 * Date               : 2025/05/20
 * Description        : This file contains all the functions prototypes for the pioc
 *                      firmware library.
 *********************************************************************************
 ...
 *******************************************************************************/
#ifndef __CH32V205_PIOC_H
#define __CH32V205_PIOC_H
...
#define PIOC_SRAM_BASE      SRAM_BASE        // PIOC code RAM base address  4K
