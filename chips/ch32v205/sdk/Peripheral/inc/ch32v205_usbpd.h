 ...
 *******************************************************************************/
#ifndef __CH32v205_USBPD_H
#define __CH32v205_USBPD_H
...
/*********************************************************
 * PD pin PA0/PA1 high threshold input mode:
...
/******************************************************************************/
#define UPD_TMR_TX_120M    (200-1)                                             /* timer value for USB PD BMC transmittal @Fsys=48MHz */
#define UPD_TMR_RX_120M    (300-1)                                            /* timer value for USB PD BMC receiving @Fsys=48MHz */
#define UPD_TMR_TX_80M     (134-1)                                             /* timer value for USB PD BMC transmittal @Fsys=48MHz */
#define UPD_TMR_RX_80M     (200-1)                                            /* timer value for USB PD BMC receiving @Fsys=48MHz */
#define UPD_TMR_TX_40M     (67-1)                                             /* timer value for USB PD BMC transmittal @Fsys=48MHz */
#define UPD_TMR_RX_40M     (100-1)                                            /* timer value for USB PD BMC receiving @Fsys=48MHz */
#define UPD_TMR_TX_10M     (14-1)                                             /* timer value for USB PD BMC transmittal @Fsys=12MHz */
#define UPD_TMR_RX_10M     (25-1)                                             /* timer value for USB PD BMC receiving @Fsys=12MHz */
