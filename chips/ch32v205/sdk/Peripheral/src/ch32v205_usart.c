...
void USART_Init(USART_TypeDef *USARTx, USART_InitTypeDef *USART_InitStruct)
{
    ...
    if ((USARTx->CTLR1 & CTLR1_OVER8_Set) != 0)
    {
        ...
        tmpreg            = (integerdivider / 100) << 3;
        fractionaldivider = integerdivider - (100 * (tmpreg >> 3));
    }
    else
    {
