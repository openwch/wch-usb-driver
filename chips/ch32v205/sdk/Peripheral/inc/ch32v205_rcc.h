 ...
 *******************************************************************************/
#ifndef __CH32V205_RCC_H
#define __CH32V205_RCC_H
...
/* PLL_multiplication_factor for other CH32V205  */
...
#define RCC_PLLMul_19                   ((uint32_t)0x00440000)
#define RCC_PLLMul_20                   ((uint32_t)0x00480000)
#define RCC_PLLMul_21                   ((uint32_t)0x004C0000)
#define RCC_PLLMul_22                   ((uint32_t)0x00500000)
#define RCC_PLLMul_23                   ((uint32_t)0x00540000)
#define RCC_PLLMul_24                   ((uint32_t)0x00580000)
#define RCC_PLLMul_25                   ((uint32_t)0x005C0000)
#define RCC_PLLMul_26                   ((uint32_t)0x00600000)
#define RCC_PLLMul_27                   ((uint32_t)0x00640000)
#define RCC_PLLMul_28                   ((uint32_t)0x00680000)
#define RCC_PLLMul_29                   ((uint32_t)0x006C0000)
#define RCC_PLLMul_30                   ((uint32_t)0x00700000)
#define RCC_PLLMul_31                   ((uint32_t)0x00740000)
#define RCC_PLLMul_32                   ((uint32_t)0x00780000)
#define RCC_PLLMul_33                   ((uint32_t)0x007C0000)
...
#define RCC_USBCLKSource_PLLCLK_Div2    ((uint32_t)0x10000000)
#define RCC_USBCLKSource_PLLCLK_Div3    ((uint32_t)0x20000000)
#define RCC_USBCLKSource_PLLCLK_Div4    ((uint32_t)0x30000000)
#define RCC_USBCLKSource_PLLCLK_Div1_5  ((uint32_t)0x40000000)
#define RCC_USBCLKSource_PLLCLK_Div2_5  ((uint32_t)0x50000000)
#define RCC_USBCLKSource_PLLCLK_Div3_5  ((uint32_t)0x60000000)
...
#define RCC_HCLK_ADC                   ((uint32_t)0x00200000)
#define RCC_ADC_USBHS_Div5             ((uint32_t)0x00400000)
#define RCC_ADC_USBHS_Div6             ((uint32_t)0x00600000)
...
#define RCC_HBPeriph_QSPI1            ((uint32_t)0x00000020)
#define RCC_HBPeriph_CRC              ((uint32_t)0x00000040)
#define RCC_HBPeriph_PIOC             ((uint32_t)0x00000080)
...
#define RCC_FLAG_USBHSPLLRDY           ((uint8_t)0x37)
...
#define RCC_ADC_H_Level_Mode1          ((uint32_t)0x00800000)

/* USBHS PLL Source clock Division*/
#define RCC_USBHSPLL_IN_Div1           ((uint32_t)0x00000000)
#define RCC_USBHSPLL_IN_Div2           ((uint32_t)0x01000000)
#define RCC_USBHSPLL_IN_Div3           ((uint32_t)0x02000000)
#define RCC_USBHSPLL_IN_Div4           ((uint32_t)0x03000000)
#define RCC_USBHSPLL_IN_Div5           ((uint32_t)0x04000000)
#define RCC_USBHSPLL_IN_Div6           ((uint32_t)0x05000000)
#define RCC_USBHSPLL_IN_Div7           ((uint32_t)0x06000000)
#define RCC_USBHSPLL_IN_Div8           ((uint32_t)0x07000000)

/* USBSS PLL Refer clock */
#define RCC_USBHSPLLRefer_5M           ((uint32_t)0x00000000)
#define RCC_USBHSPLLRefer_8M           ((uint32_t)0x10000000)
#define RCC_USBHSPLLRefer_20M          ((uint32_t)0x20000000)
#define RCC_USBHSPLLRefer_24M          ((uint32_t)0x30000000)

/* USBHSPLL_clock_source */
#define RCC_USBHSPLLSource_HSE         ((uint32_t)0x00000000)
#define RCC_USBHSPLLSource_HSI         ((uint32_t)0x08000000)

/* USBFS_clock_source */
#define RCC_USBFSCLKSource_USBHSPLL    ((uint32_t)0x80000000)
#define RCC_USBFSCLKSource_PLL         ((uint32_t)0x00000000)
...
void        RCC_USBHSPLLReferConfig(uint32_t RCC_USBSSPLLRefer);
